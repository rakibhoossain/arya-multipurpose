...
if ( ! function_exists( 'arya_multipurpose_get_default_theme_options' ) ) {
    ...
    function arya_multipurpose_get_default_theme_options() {
        ...
        $defaults = array(
            ...
            'arya_multipurpose_fm_link' => 'https://geekanddummy.com/wp-content/uploads/2014/02/ambient-noise-server-room.mp3',
            'arya_multipurpose_fm_bg' => 'https://images.pexels.com/photos/2683138/pexels-photo-2683138.jpeg',
            'arya_multipurpose_fm_text' => 'https://dummyimage.com/148x33/000000/0011ff&text=Small+LOGO',
            'arya_multipurpose_fm_lg_logo' => 'https://dummyimage.com/343x343/000000/0011ff&text=BIG+LOGO',
