...
class Customizer_Text_Editor_Control extends WP_Customize_Control {
    ...
    public function enqueue(){
      wp_enqueue_script( 'magazil_tinimc__editor', trailingslashit( get_template_directory_uri() ) . 'customizer/assets/js/custom-editor.js', array( 'jquery' ), '1.0', true );
      wp_enqueue_style( 'magazil_tinimc__editor', trailingslashit( get_template_directory_uri() ) . 'customizer/assets/css/custom-editor.css', array(), '1.0', 'all' );
      wp_enqueue_editor();
    }
    /**
